...
class MyPopupDialog(QWidget):
    def __init__(self, parent=None):
        super().__init__()
        layout = QFormLayout()
        self.setWindowTitle("Information sur les Pluies")
        ...
        self.button_ok.setText("Enregistrement des pluies")
...
class pluie(QWidget):
    def __init__(self, parent=None):
        ...
        #       Enregistrement des valeurs de pluies pour :
        # une ville (base de données initiale)
        # avec une période (1, 5, 10, 20, 30, 50, 75, 100 ans)
        # pour une durée soit de 0 à 360 minutes ou 360 minutes à 24 heures
        # avec des coefficients a et b




        self.hbox = QHBoxLayout()
        self.un = QRadioButton("1 An")
        self.cinq = QRadioButton("5 Ans")
        self.dix = QRadioButton("10 Ans")
        self.vingt = QRadioButton("20 Ans")
        self.trente = QRadioButton("30 Ans")
        self.cinquante = QRadioButton("50 Ans")
        self.soixantequinze = QRadioButton("75 Ans")
        self.cent = QRadioButton("100 Ans")
        self.hbox.addWidget(self.un)
        self.hbox.addWidget(self.cinq)
        self.hbox.addWidget(self.dix)
        self.hbox.addWidget(self.vingt)
        self.hbox.addWidget(self.trente)
        self.hbox.addWidget(self.cinquante)
        self.hbox.addWidget(self.soixantequinze)
        self.hbox.addWidget(self.cent)
        self.dix.setChecked(True)
        self.hbox.addStretch()
        # enregistrement de la valeur dans ==> PERIODE
